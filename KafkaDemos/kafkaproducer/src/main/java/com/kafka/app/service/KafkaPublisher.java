...
public class KafkaPublisher {
	...
	public void publishMessage(String message) {
		CompletableFuture<SendResult<String, Object>> future = template.send("random-topic-4",message);
...
//		});
	...
	{
		CompletableFuture<SendResult<String, Object>> future=template.send("random-topic-4",customer);
